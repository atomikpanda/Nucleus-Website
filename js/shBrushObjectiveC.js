...
{
	var datatypes =	'char bool BOOL double float int long short id void self IMP Method IBAction IBOutlet SEL YES NO Class';
	
	var keywords = 'readwrite readonly nonatomic nil NULL ';
	...
	this.regexList = [
		...
		{ regex: new RegExp('\\bNS\\w+\\b', 'g'),					css: 'variable' },			// var
		{ regex: /\b(\w+\s+)\*\b/g,					css: 'variable' },							// var
		{ regex: new RegExp('@\\w+\\b', 'g'),						css: 'keyword' },			// keyword
		{regex: new RegExp('(@".+[^"]")',"gm"), css:'NSString'},
		{regex: /(\w+):/g, css:'method'},
		{regex: /(\w+\()/g, css:'c-function'}
		//{regex: /(\))/g, css:'c-function'}
		];
}
